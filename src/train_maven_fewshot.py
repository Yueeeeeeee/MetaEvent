...
def train_fewshot(args):
    ...
    train_loader, val_loader, test_loader, vocab = get_maven_loaders(args, args.N, args.K, args.max_len, 
    ...
    model = ModifiedRoberta.from_pretrained('roberta-base', num_labels=2).to(args.device)  # 45-way formulated as binary classification
    ...
    test_f1_micro = evaluation(args, model, scaler, inner_loop_optimizer, test_iter)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--N', default=1, type=int, help='number of classes (both training and evaluation)')  # 45-way but formulated as binary classication
